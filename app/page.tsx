...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col flex-1 items-center pt-5 font-sans w-full gap-y-5">
      ...
      <div className="w-full h-90 bg-card rounded-2xl shadow-md flex-col flex items-center shrink-0 border-black border-2 ">
        ...
        <div className="flex h-full w-[95%] ">
          ...
          <div className="py-5 h-full w-full gap-y-5 flex flex-col ">
            ...
            <h1 className="text-card-secondary font-bold text-xl">Dati di magazzino</h1>
            <div className="flex flex-row gap-x-4 h-full w-full">

              <div className="h-full w-full gap-y-6 flex flex-col p-5 bg-card-secondary rounded-2xl">
          ...
          <div className="bg-card-secondary/10 w-1 mx-5 self-center h-[90%]" />

          <div className="py-5 h-full w-full gap-y-5 flex flex-col  ">

            <h1 className="text-card-secondary font-bold text-xl">Progressi</h1>
            <div className="flex flex-row gap-x-4 h-full w-full ">

              <div className="h-full w-full bg-card-secondary rounded-2xl flex p-5 gap-x-2">
